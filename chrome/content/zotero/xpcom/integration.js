...
Zotero.Integration = new function () {
	...
	this.init = function () {
		...
		if (!pipe) {
			...
			pipe = Components.classes["@mozilla.org/file/directory_service;1"].getService(Components.interfaces.nsIProperties).get("Home", Components.interfaces.nsIFile);
 ...
 */
Zotero.Integration.MissingItemException = function (item) {
	this.item = item;
};
...
Zotero.Integration.DocumentData.prototype.unserializeXML = function (xmlData) {
	...
	this.style = {
		"styleID": Zotero.Utilities.xpathText(doc, '/data/style[1]/@id'),
