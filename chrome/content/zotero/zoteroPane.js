...
var ZoteroPane = new function () {
	...
	function _loadPane() {
		...
		setTimeout(function () {
			ZoteroPane.showExpressionsOfConcernBanner();
		});
	...
	this.buildItemTypeSubMenu = function () {
		...
		for (var i = 0; i < itemTypes.length; i++) {
			...
			menuitem.addEventListener("command", function () {
				ZoteroPane_Local.newItem(type, {}, null, true).done();
			}, false);
	...
	var _collectionContextMenuOptions = [
		...
		},
		{
			id: "duplicate",
			oncommand:
					() => this.duplicateSelectedCollection()
		},
		{
			id: "markReadFeed",
			oncommand:
		...
		},
		{
			...
			oncommand:
					() => this.deleteSelectedCollection(true)
		},
		{
			id: "sep3",
		},
		...
		},
		{
			...
			oncommand:
					() => Zotero_File_Interface.bibliographyFromCollection()
		},
		{
			id: "exportFile",
			oncommand:
					() => Zotero_File_Interface.exportFile()
		},
		{
			id: "loadReport",
			oncommand:
					event => Zotero_Report_Interface.loadCollectionReport(event)
		},
		{
			id: "emptyTrash",
			oncommand:
		...
		},
		{
			id: "removeLibrary",
			label:
					Zotero.getString('pane.collections.menu.remove.library'),
			oncommand:
					() => {
